...
public class Pajak {
    public enum jabatan{
        GENERALMANAGER,MANAGER,ASISTANTMANAGER,SENIORMANAGER,JUNIORMANAGER,TEKNISI,DRIVER
    }
    public double hitungBiayaJabatan(jabatan namaJabatan,String tanggalPengangkatan,String tanggalPerhitungan){
        ...
        if(hasilPerbandinganTanggal > 0){
            ...
            System.out.println("perhitungan tanggal error");
        }
        ...
        } else if(namaJabatan == jabatan.ASISTANTMANAGER) {
            gajiPokok = 6000000;
